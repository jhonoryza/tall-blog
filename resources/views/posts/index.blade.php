@foreach ($posts as $post)
    <div class="item mb-5">
        <div class="row g-3 g-xl-0">
            ...
            <div class="col">
                <h3 class="title mb-1"><a class="text-link" href="{{ route('posts.show', $post->getKey()) }}">{{ $post->title }}</a></h3>
                ...
                <a class="text-link" href="{{ route('posts.show', $post->getKey()) }}">Read more &rarr;</a>
            </div><!--//col-->
        </div><!--//row-->
    </div><!--//item-->
@endforeach
